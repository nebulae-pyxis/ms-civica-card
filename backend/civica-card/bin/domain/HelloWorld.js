...
class HelloWorld {
  ...
  initHelloWorldEventGenerator(){
    ...
    .subscribe(
      (evt) => console.log('sales-gateway GraphQL sample event sent, please remove'),
      (err) => { 
        console.log(err);
        console.error('sales-gateway GraphQL sample event sent ERROR, please remove')
      },
      () => console.log('sales-gateway GraphQL sample event sending STOPPED, please remove'),
    );
  }

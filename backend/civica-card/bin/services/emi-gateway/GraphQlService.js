    ...
    return [
      {
        ...
        messageType: "emigateway.graphql.query.civicaCardSalesHistory"
      },
      {
        aggregateType: "CivicaCard",
        messageType: "emigateway.graphql.query.civicaCardSalesHistoryAmount"
      },
      {
        aggregateType: "CivicaCard",
  ...
  generateFunctionMap() {
    return {
      "emigateway.graphql.query.civicaCardSalesHistory": {
        fn: civicaCardCQRS.getCivicaCardSalesHistory$,
        obj: civicaCardCQRS
      },
      "emigateway.graphql.query.civicaCardSalesHistoryAmount": {
        fn: civicaCardCQRS.getCivicaCardSalesHistoryAmount$,
        obj: civicaCardCQRS
      },

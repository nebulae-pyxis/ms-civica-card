...
module.exports = {
    ...
    Mutation: {
        startCivicaCardReloadConversation(root, args, context) {
            ...
            .pipe(
                mergeMap(() => broker.forwardAndGetReply$("CivicaCard", "salesgateway.graphql.mutation.startCivicaCardReloadConversation", { root, args, jwt: context.encodedToken }, 500)),
        ...
        setCivicaCardReloadConversationUiState(root, args, context) {
            ...
            .pipe(
                mergeMap(() => broker.forwardAndGetReply$("CivicaCard", "salesgateway.graphql.mutation.setCivicaCardReloadConversationUiState", { root, args, jwt: context.encodedToken }, 500)),
                mergeMap(response => getResponseFromBackEnd$(response))
            ).toPromise();                
        },
        ...
        generateCivicaCardReloadSecondAuthToken(root, args, context) {
            ...
            .pipe(
                mergeMap(() => broker.forwardAndGetReply$("CivicaCard", "salesgateway.graphql.mutation.generateCivicaCardReloadSecondAuthToken", { root, args, jwt: context.encodedToken }, 7000)),
                mergeMap(response => getResponseFromBackEnd$(response))
            ).toPromise();
        },
        ...
        generateCivicaCardReloadReadApduCommands(root, args, context) {
            ...
            .pipe(
                mergeMap(() => broker.forwardAndGetReply$("CivicaCard", "salesgateway.graphql.mutation.generateCivicaCardReloadReadApduCommands", { root, args, jwt: context.encodedToken }, 7000)),
                mergeMap(response => getResponseFromBackEnd$(response))
            ).toPromise();
        },
        ...
        processCivicaCardReloadReadApduCommandRespones(root, args, context) {
            ...
            .pipe(
                mergeMap(() => broker.forwardAndGetReply$("CivicaCard", "salesgateway.graphql.mutation.processCivicaCardReloadReadApduCommandRespones", { root, args, jwt: context.encodedToken }, 1000)),
                mergeMap(response => getResponseFromBackEnd$(response))
            ).toPromise();
        },
        ...
        purchaseCivicaCardReload(root, args, context) {
            ...
            .pipe(
                mergeMap(() => broker.forwardAndGetReply$("CivicaCard", "salesgateway.graphql.mutation.purchaseCivicaCardReload", { root, args, jwt: context.encodedToken }, 1000)),
                mergeMap(response => getResponseFromBackEnd$(response))
            ).toPromise();
        },
        ...
        generateCivicaCardReloadWriteAndReadApduCommands(root, args, context) {
            ...
            .pipe(
                mergeMap(() => broker.forwardAndGetReply$("CivicaCard", "salesgateway.graphql.mutation.generateCivicaCardReloadWriteAndReadApduCommands", { root, args, jwt: context.encodedToken }, 7000)),
                mergeMap(response => getResponseFromBackEnd$(response))
            ).toPromise();
        },
        ...
        processCivicaCardReloadWriteAndReadApduCommandResponses(root, args, context) {
            ...
            .pipe(
                mergeMap(() => broker.forwardAndGetReply$("CivicaCard", "salesgateway.graphql.mutation.processCivicaCardReloadWriteAndReadApduCommandResponses", { root, args, jwt: context.encodedToken }, 4000)),
                mergeMap(response => getResponseFromBackEnd$(response))
            ).toPromise();
        },
